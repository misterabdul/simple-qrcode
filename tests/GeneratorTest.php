...
class GeneratorTest extends TestCase
{
    ...
    public function test_eye_color_is_set()
    {
        ...
        $this->assertEquals(0, $generator->getFill()->getTopLeftEyeFill()->getExternalColor()->toRgb()->getRed());
        $this->assertEquals(0, $generator->getFill()->getTopLeftEyeFill()->getExternalColor()->toRgb()->getGreen());
        $this->assertEquals(0, $generator->getFill()->getTopLeftEyeFill()->getExternalColor()->toRgb()->getBlue());
        $this->assertEquals(255, $generator->getFill()->getTopLeftEyeFill()->getInternalColor()->toRgb()->getRed());
        $this->assertEquals(255, $generator->getFill()->getTopLeftEyeFill()->getInternalColor()->toRgb()->getGreen());
        $this->assertEquals(255, $generator->getFill()->getTopLeftEyeFill()->getInternalColor()->toRgb()->getBlue());

        $this->assertEquals(0, $generator->getFill()->getTopRightEyeFill()->getExternalColor()->toRgb()->getRed());
        $this->assertEquals(0, $generator->getFill()->getTopRightEyeFill()->getExternalColor()->toRgb()->getGreen());
        $this->assertEquals(0, $generator->getFill()->getTopRightEyeFill()->getExternalColor()->toRgb()->getBlue());
        $this->assertEquals(255, $generator->getFill()->getTopRightEyeFill()->getInternalColor()->toRgb()->getRed());
        $this->assertEquals(255, $generator->getFill()->getTopRightEyeFill()->getInternalColor()->toRgb()->getGreen());
        $this->assertEquals(255, $generator->getFill()->getTopRightEyeFill()->getInternalColor()->toRgb()->getBlue());

        $generator = (new Generator)->eyeColor(2, 0, 0, 0, 255, 255, 255);
        $this->assertEquals(0, $generator->getFill()->getBottomLeftEyeFill()->getExternalColor()->toRgb()->getRed());
        $this->assertEquals(0, $generator->getFill()->getBottomLeftEyeFill()->getExternalColor()->toRgb()->getGreen());
        $this->assertEquals(0, $generator->getFill()->getBottomLeftEyeFill()->getExternalColor()->toRgb()->getBlue());
        $this->assertEquals(255, $generator->getFill()->getBottomLeftEyeFill()->getInternalColor()->toRgb()->getRed());
        $this->assertEquals(255, $generator->getFill()->getBottomLeftEyeFill()->getInternalColor()->toRgb()->getGreen());
        $this->assertEquals(255, $generator->getFill()->getBottomLeftEyeFill()->getInternalColor()->toRgb()->getBlue());
    }
